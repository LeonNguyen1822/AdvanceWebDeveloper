...
// Check the result's profile name and friend count.
  ...
  //Fetch and display the list of friends for the user.
  ...
  function deleteFriend($friendId)
  {
    ...
    // delete the friend relationship between the logged-in user and the friend identified by $friendId.
