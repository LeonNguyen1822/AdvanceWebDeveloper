<!DOCTYPE html>
    <html lang="en">
        ...
        <body>
            ...
            $monster1 = new Monster(1, "<b style=\"color:red\">red</b>");          // creates a red monster with 1 eye
            $monster2 = new Monster(3, "<b style=\"color:blue\">blue</b>");         // creates a blue monster with 3 eyes
